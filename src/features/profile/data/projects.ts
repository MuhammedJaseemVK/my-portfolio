...
export const PROJECTS: Project[] = [
  {
    id: "fresher-park-kerala",
    title: "Fresher Park Kerala",
    period: { start: "10.2024" },
    link: "https://github.com/MuhammedJaseemVK/Fresher-park-kerala",
    skills: [
      "React",
      "Node.js",
      "JavaScript",
    ...
    description: `A job platform dedicated to helping freshers and early-career professionals in Kerala find opportunities.
- Curated job postings for freshers and entry-level roles updated daily
- Internship and career opportunity updates

 **Demo:** [View Live](https://fresher-park-kerala.onrender.com/)`,
