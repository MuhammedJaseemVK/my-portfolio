...
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  //   description: "@abdul-rehman-waseem",
  //   href: "https://stackoverflow.com/users/23184188/abdul-rehman-waseem",
  //   padding: true,
  // },
  // {
